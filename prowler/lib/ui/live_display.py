...
from prowler.providers.aws.models import AWSAssumeRoleInfo, AWSIdentityInfo
...
class LiveDisplay(Live):
    ...
    def print_aws_credentials(
        self, aws_identity_info: AWSIdentityInfo, assumed_role_info: AWSAssumeRoleInfo
    ):
...
- [fail]FAIL (Fix required)[/fail]
    ...
    def add_aws_credentials(
        ...
        profile = (
            aws_identity_info.profile
            if aws_identity_info.profile is not None
            else "default"
        )
